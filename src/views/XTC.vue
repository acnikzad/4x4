              ...
              <!-- Content -->
                <div id="content" class="col-8 col-12-medium">
                  ...
                  <article class="box post">
                    <header>
                      <h2><strong>XTC</strong></h2>
                    </header>
                    <span class="image featured"><img src="images/XTC_VintageTrailerWorks00007.jpg" alt="" /></span>
                  </article>
                </div>
<!-- Sidebar -->
...
<!-- Galley Options -->
                  <article class="box excerpt options" id="galley">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">Commander Kitchen (All options, no stove)</th>
                          <td>$2,725</td>
                        </tr>
                      </tbody>
                    </table>
