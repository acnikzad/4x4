              ...
              <!-- Content -->
                <div id="content" class="col-8 col-12-medium">
                  ...
                  <article class="box post">
                    <header>
                      <h2><strong>XTR - XL</strong></h2>
                    </header>
                    <span class="image featured"><img src="images/XTR XL1.jpg" alt="" /></span>
                  </article>
                </div>
<!-- Sidebar -->
          ...
          <article class="box post">
            ...
            <div style="text-align: center">
              <button class="button"><a href="mailto:benk.vtw@gmail.com?&subject=XTR-XL%20Inquiry&body=I%20am%20interested%20in%20learning%20more%20about%20the%20XTR-XL!" target="_top">Contact for a quote!</a></button>
            </div>
            <br>
            <br>
          </article>
...
<!-- Tongue -->
                  <article class="box excerpt storagehide" id="tongue">
                    ...
                    <table class="table table-sm">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">Lock and Roll Multi-Axis Hitch Includes Vehicle and Camper Sides</th>
                          <td>$520</td>
                        </tr>
                      </tbody>
                    </table>
